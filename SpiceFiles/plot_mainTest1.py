"""Plot mainTest1.spi — write 1111/read/write 0000/read @ addr 1."""
import numpy as np
import matplotlib.pyplot as plt
from pathlib import Path

HERE = Path(__file__).parent
DATA = HERE / "mainTest1_results.txt"
OUT  = HERE.parent / "figures" / "mainTest1_waveforms.png"
...
fig.suptitle("mainTest-1: wr 1111 -> rd -> wr 0000 -> rd  @ addr 1   (500 MHz, WrEn fix)", fontsize=12)
...
for x, lbl in [(1.0,"WRITE 1111"),(3.0,"READ"),(5.0,"WRITE 0000"),(7.0,"READ")]:
...
expected = {"cyc1 wr 1111":"1111","cyc2 rd":"1111","cyc3 wr 0000":"0000","cyc4 rd":"0000"}
for cyc, when in [("cyc1 wr 1111",1.9),("cyc2 rd",3.9),("cyc3 wr 0000",5.9),("cyc4 rd",7.9)]:
    rv = [at(R[i], when) for i in range(4)]
    rbits = "".join("1" if v>0.4 else "0" for v in reversed(rv))
    rs = " ".join(f"{v:.3f}" for v in reversed(rv))
    print(f"  t={when:.2f}ns  {cyc:14s}  R3..R0=[{rs}]  -> {rbits}  expect {expected[cyc]}")
