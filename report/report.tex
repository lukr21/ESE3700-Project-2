...
\graphicspath{{../figures/}{../figures/breakdown/}{../schematics/}}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\linewidth]{worst_case_read_zoom.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\linewidth]{worst_case_write_zoom.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.98\linewidth]{mainTest1_per_cycle_zoom.png}
  \caption{Per-cycle zoom of \texttt{mainTest1}. Each cycle shows clean
    precharge, WL pulse, BL transition, SAE firing, and output resolution.}
  \label{fig:main1zoom}
\end{figure}
